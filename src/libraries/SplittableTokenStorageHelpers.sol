...
import {DelegateTokenErrors as Errors, DelegateTokenStructs as Structs} from "src/libraries/SplittableTokenLib.sol";


library SplittableTokenStorageHelpers {
    ///////////// ID Flags /////////////
    ...
    uint256 internal constant PACKED_INFO_POSITION = 1; // PACKED (address approved, uint256 start_timestamp, enum duration)
    ...
    enum TokenDuration {DAY, WEEK, MONTH};
